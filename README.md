...
HeyShop is a **scalable, multi-vendor e-commerce frontend** built with **Next.js and React**, designed to integrate seamlessly with a Laravel backend.

This project is fully **dynamic and API-driven**, allowing UI and content to be managed from the backend without modifying frontend code.
