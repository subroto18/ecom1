...
} from "../../../services/actions/commonAction";
...
class LoginPart extends PureComponent {
  constructor(props) {
    ...
    this.handleSocialFacebookErrorLogin =
      this.handleSocialFacebookErrorLogin.bind(this);
    this.handleSocialGoogleErrorLogin =
      this.handleSocialGoogleErrorLogin.bind(this);
  ...
  componentDidMount() {
    ...
    document.addEventListener(
      "keydown",
      (e) => e.code === "Enter" && this.submitForm(),
    );
  }
  onEmailCheck(e) {
    this.setState({
        ...
        <div className="loginDiv">
          <div className="login-input">
            ...
            <div>
              ...
              {this.props.banUser === 1 ? (
                <Fragment>
                  <Fragment>
                    <p className="mb-2 alert alert-danger">
                      <i className="far fa-exclamation-circle" /> Account has
                      been suspended!{" "}
                    </p>
                  </Fragment>
                </Fragment>
                  ...
                  {this.state.loginUsing === "email" ? (
                    <Fragment>
                      {this.props.passwordNotMatch && (
                        <p className="mb-2 alert alert-danger">
                          <i className="far fa-exclamation-circle" /> Email or
                    ...
                    <Fragment>
                      {this.props.passwordNotMatch && (
                        <p className="mb-2 alert alert-danger">
                          <i className="far fa-exclamation-circle" /> Phone
                          number or password does not match{" "}
                        </p>
                      )}
                    </Fragment>
                  )}
            ...
            <Form>
              {this.state.loginUsing == "email" ? (
                <Fragment>
                  <InputGroup className="loginInputGroup">
                    <InputGroup.Prepend className="loginRegistrationInputField">
                      <InputGroup.Text className="loginRegistrationIcon">
                        <i className="inputIcon fas fa-envelope" />
                      </InputGroup.Text>
                    </InputGroup.Prepend>
                    <FormControl
                      onChange={(e) => this.onEmailCheck(e)}
                  ...
                  <span
                    onClick={() => this.onChangeLoginMethod("phone")}
                    className="float-right usePhoneNumberText change-login-mode-btn"
                  >
                ...
                <Fragment>
                  ...
                  <span
                    onClick={() => this.onChangeLoginMethod("email")}
                    className="float-right change-login-mode-btn"
                  >
                    use email number instead
                  </span>
                  <div className="mb-2 mt-2 text-danger errorText">
                    {this.validator.message(
                      "phone",
                      this.state.phone,
                      "required|phone",
              ...
              <InputGroup className="loginInputGroup passwordInput">
                <InputGroup.Prepend className="loginRegistrationInputField">
                  <InputGroup.Text className="loginRegistrationIcon">
                    <i className="inputIcon fas fa-lock" />
                  </InputGroup.Text>
                </InputGroup.Prepend>
                <FormControl
                  onChange={(e) => this.onPasswordCheck(e)}
                  className="loginForm inputTextField"
                  placeholder="Password"
                  type="password"
                />
              </InputGroup>
              <p className="mb-2 text-danger errorText">
                {" "}
                {this.validator.message(
                  "password",
                  this.state.password,
          ...
          <Row>
            ...
            <Col lg={6} md={6}>
              <Link
                ...
                className="float-right forget-password-btn"
              >
                Forget Password?
              </Link>
            </Col>
          ...
          <Col lg={12} md={12} sm={12} xs={12} className="p-0">
                  ...
                  <Fragment>
                    {this.props.userLoading ? (
                      <Button disabled className="w-100 login-btn btn">
                        <div
                          className="spinner-border text-light login-btn-spinner"
                          role="status"
                        >
            ...
            <p className="text-center mt-2">
              ...
              <Link class="loginLink" href="/user/registration">
                Click here
              </Link>
            </p>
          </Col>
