                                ...
                                <Col xl={2} lg={2} md={2} sm={12} xs={12} >
                                    <ul className="cart-function d-flex justify-content-center align-items-center">
                                        <li className="compare-nav-item">
                                            <Link href="/compare" title="Compare" className="cartIcon"><i className="far fa-sync-alt faCartIcon"/> <sup><span className="badge text-white bg-danger">{this.props.compareProductId.length}</span></sup></Link>
                                        </li>
                                        <li className="wishlist-nav-item">
                                            {this.props.isAuthorized ?
                                                <>
                                                    <Link title="Wishlish" href="/wishlist" className="cartIcon" ><i className="far fa-heart faCartIcon"/> <sup><span className="badge text-white bg-danger">{this.props.wishlistItem}</span></sup></Link>
                                                </>
                                                :
                                                <OverlayTrigger
                                                    placement="bottom"
                                                    ...
                                                    overlay={wishlist()}
                                                >
                                                    <Link href="/login"><i className="far fa-heart faCartIcon"/></Link>
                                                </OverlayTrigger>
                                            }
                                        </li>
                                        <li className="cart-nav-item">
                                            {this.props.isAuthorized ?
                                                    <Link title="Cart" href="/cart" className="cartIcon"><i className="far fa-cart-plus faCartIcon"></i> <sup><span className="badge text-white bg-danger">{this.props.cartItem}</span></sup></Link>
                                                :
                                                <OverlayTrigger
                                                    placement="bottom"
                                                    delay={{ show: 250, hide: 400 }}
                                                    overlay={cart()}
                                                >
                                                    <Link href="/login"><i className="far fa-cart-plus faCartIcon"/></Link>
                                                </OverlayTrigger>
                                            }
                                        </li>
                                        {
                                            this.props.isAuthorized   ?
                                                                ...
                                                                <Popover id={`popover-positioned-${placement}`}>
                                                                    <Popover.Content>
                                                                        <ul className="popoverUl">
                                                                            <li><Link className="accountLink"  href="/dashboard">
                                                                                <i className="far fa-user mr-2"></i> My Account </Link></li>
                                                                            <li><Link href="" onClick={this.onLogout} className="accountLink" ><i
                                                                                className="far fa-sign-out-alt mr-2"></i>  LogOut </Link></li>
                                                                        </ul>
                                                                    </Popover.Content>
                                                                </Popover>
                                                            }
                                                        >
                                                            <Button variant="loginBtn"><i className="far fa-user-circle faCartIcon"></i></Button>
                                                        </OverlayTrigger>
                                                    ))}
                                                </>
                                                :
                                                <li>
                                                    <OverlayTrigger
                                                        ...
                                                        overlay={profile}
                                                    >
                                                        <Link href="/login" ><i className="far fa-user-circle faCartIcon"></i></Link>
                                                    </OverlayTrigger>
                                                </li>
                                        }
                                    </ul>
